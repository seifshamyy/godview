...
export default function AgentLeaderboardPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-lg font-bold text-white">Agent Leaderboard</h1>
            ...
            <tbody className="divide-y divide-gray-800/60">
              {agents.map(agent => (
                ...
                >
                  ...
                  <td className="px-3 py-2 text-gray-300">{agent.live_listings}</td>
                  <td className="px-3 py-2 text-gray-400">{agent.total_listings}</td>
                  <td className="px-3 py-2 text-gray-300 font-medium">{agent.total_leads}</td>
