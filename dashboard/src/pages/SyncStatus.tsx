  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-bold text-gray-900">Sync Status</h1>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {!isRunning && (
                    <button
                      ...
                      className="text-xs text-brand-600 hover:text-brand-300 flex items-center gap-1 disabled:opacity-50"
                    >
          ...
          <table className="w-full text-xs">
            ...
            <tbody className="divide-y divide-gray-200">
              {all.slice(0, 50).map(log => (
                <tr key={log.id}>
                  <td className="px-3 py-2 text-gray-600 capitalize font-medium">{log.sync_type}</td>
